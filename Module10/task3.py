...
class Building:
    ...
    def fire_alarm(self):
        print("FIRE ALARAM! Move all elevators to the bottom floor. ")
        for number,elevator in enumerate(self.elevators):
            print(f"Elevator{number}:")
            elevator.go_to_floor(self.bottom_floors)
# main program
b= Building(1,10,3)
b.run_elevator(0,4)
b.run_elevator(1,7)
